<?php
    ...
    $articles = mysqli_query($connect, "SELECT * FROM `article` WHERE `id` = '$articles_id'");
  ...
  <section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url('img/shop.jpg');">
      ...
      <div class="container">
        ...
        <h3>Редактировать</h3>
    <form action="vendor/update__article.php" method="post">
      <input type="hidden" name="id" value="<?= $articles['id'] ?>">
        <p>Название</p>
        <input type="text" name="article_name" value="<?= $articles['article_name'] ?>">
        <p>Описание</p>
        <textarea name="article_description"><?= $articles['article_description'] ?></textarea> <br> <br>
