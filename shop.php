          ...
          <div class="major-caousel js-carousel-1 owl-carousel">
            ...
            foreach ($products as $product) {
              ...
              <div class="media d-block media-custom text-center">
                ...
                <a href="update.php?id=<?= $product[0] ?>" class="p-2"><span class="fa fa-pencil"></span></a>
                <a href="vendor/delete_toy.php?id=<?= $product[0] ?>" class="p-2"><span class="fa fa-trash"></span></a>
              </div>
              </div>
            </div>
            <div>
          ...
          <div class="major-caousel js-carousel-1 owl-carousel">
            ...
            foreach ($products_feed as $product_feed) {
              ...
              <div class="media-body">
                ...
                <a href="update_feed.php?id=<?= $product_feed[0] ?>" class="p-2"><span class="fa fa-pencil"></span></a>
                <a href="vendor/delete_feed.php?id=<?= $product_feed[0] ?>" class="p-2"><span class="fa fa-trash"></span></a>
                 </div>
              </div>
            </div>
            <div>
