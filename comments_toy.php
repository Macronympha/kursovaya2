<?php
    ...
    $product = mysqli_query($connect, "SELECT * FROM `products_toy` WHERE `id` = '$product_id'");
    ...
    $comments = mysqli_query($connect, "SELECT * FROM `comments_toy` WHERE `product_id` = '$product_id'");
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
         ...
         <div class="row element-animate">
              <div class="media d-block media-custom text-center"><img src="img/toy_1.png" alt="Image Placeholder" class="img-fluid">
                        <div class="media-body">
                          <h3 class="mt-0 product__name"><?= $product['name'] ?></h3>
                          <div class="mt-0 text-black"><?= $product['description'] ?></div>
                          <div class="mt-0 text-black"><?= $product['price'] ?>&#8381;</div>
...
<form action="vendor/comments__toy.php" method="post">
